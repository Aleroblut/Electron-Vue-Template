...
Updated Electron, Vue 2 and Webpack template. Original template can be found at https://github.com/pastahito/electron-vue-webpack

## Install
``` bash
# Clone the repository once
$ git clone https://github.com/Aleroblut/Electron-Vue-Template.git
